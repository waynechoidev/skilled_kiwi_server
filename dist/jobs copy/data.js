...
var SELECT_JOIN = 'SELECT jo.id, jo.text, jo.createdAt, jo.userId, us.username, us.name, us.url FROM jobs as jo JOIN users as us ON jo.userId=us.id';
var ORDER_DESC = 'ORDER BY jo.createdAt DESC';
function getAll() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2, mysql_1.db
                    .execute("".concat(SELECT_JOIN, " ").concat(ORDER_DESC))
...
function getAllByUsername(username) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2, mysql_1.db
                    .execute("".concat(SELECT_JOIN, " WHERE username=? ").concat(ORDER_DESC), [username])
                    .then(function (result) { return result[0]; })];
        });
    });
}
